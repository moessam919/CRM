    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2  gap-2">
                ...
                <div className="mt-3">
                    <p className="text-2xl font-bold mb-1">
                        {customer?.total_sales
                            ? `${Number(customer.total_sales.toFixed(2)).toLocaleString()} ريال`
                            : "لا يوجد"}
                    </p>
            ...
            <div className="bg-white p-5 rounded-md shadow-md hover:translate-y-1 duration-200">
                ...
                <div className="mt-3">
                    <p className="text-2xl font-bold mb-1">
                        {customer?.last_month_sales
                            ? `${Number(Number(customer.last_month_sales).toFixed(2)).toLocaleString()} ريال`
                            : "لا يوجد"}
                    </p>
                    <span className="text-green-500 text-xs font-bold">
                        +20% من الشهر السابق
